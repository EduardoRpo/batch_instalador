...
class batchEnvasadoDao
{
    ...
    public function findBatchEnvasadoxDate($date1, $date2)
    {
        ...
        $sql = "SELECT DISTINCT batch.programacion_envasado, batch.pedido, batch.id_batch, multi.referencia as referencia_comercial, multi.cantidad, batch.ok_aprobado
                FROM batch
                ...
                AND programacion_envasado >= :startDate AND programacion_envasado <= :endDate
