      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="insertarRefMulti mb-3 mt-3">
              ...
              <input type="text" class="form-control derecha" id="txtcantidadMulti1" name="cantidadMulti" placeholder="Unidades" onblur="CalculoloteMulti(1, this.value);">
              ...
              <input type="text" class="form-control derecha" id="txtcantidadMulti2" name="cantidadMulti" placeholder="Unidades" onblur="CalculoloteMulti(2, this.value);">
              ...
              <input type="text" class="form-control derecha" id="txtcantidadMulti3" name="cantidadMulti" placeholder="Unidades" onblur="CalculoloteMulti(3, this.value);">
              ...
              <input type="text" class="form-control derecha" id="txtcantidadMulti4" name="cantidadMulti" placeholder="Unidades" onblur="CalculoloteMulti(4, this.value);">
              ...
              <input type="text" class="form-control derecha" id="txtcantidadMulti5" name="cantidadMulti" placeholder="Unidades" onblur="CalculoloteMulti(5, this.value);">
