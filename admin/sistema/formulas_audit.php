...
<head>
    ...
    <title>Samara Cosmetics | Auditoria</title>
...
<body class="">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Bitacora y auditoria de formulas</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="" style="display: flex;">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table-bordered" id="tblAuditoriaFormulas">
                                        </table>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="js/auditoriaFirmas/tblAuditoriaFormulas.js"></script>
