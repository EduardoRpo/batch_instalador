...
$(document).ready(function () {
  $("#tblModulos").DataTable({
    ...
    columns: [
      ...
      {
        defaultContent:
          "<a href='#' <i class='large material-icons link-editar' style='color:rgb(255, 165, 0)'>edit</i></a>",
      },
      {
        defaultContent:
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == 1) {
            ...
            alertify.set("notifier", "position", "top-right");
            alertify.error(
              "El proceso se encuentra relacionado con uno o más procesos y no es posible eliminarlo"
            );
          }
        },
      });
