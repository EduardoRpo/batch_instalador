...
<head>
  ...
  <title>Samara Cosmetics | Parametros</title>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <hr>
                <button type="button" class="btn btn-primary" id="adLineas">Adicionar Equipos</button>
                <form id="frmadLineas" style="display: none;">
                  <label for=""><b>Equipo</b></label>
                  <label for=""><b>Línea</b></label>
                  
                  <input type="text" name="equipo" id="equipo" class="form-control" placeholder="Linea">
